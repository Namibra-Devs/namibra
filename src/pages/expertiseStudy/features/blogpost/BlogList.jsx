    ...
    <div className='text-center'>
        <div className='grid grid-cols-1 md:grid-cols-2 align-center gap-x-24 gap-y-14 mb-14'>
            {blogs.map((blog, index) => (
                <div key={index}>
                    <a href={blog.link} className='flex gap-2 group hover:shadow-inner duration-700 rounded-xl'>
                        <img src={blog.img} alt={blog.title} className='w-40 h-32 object-cover group-hover:brightness-75 duration-700 rounded-xl' />
